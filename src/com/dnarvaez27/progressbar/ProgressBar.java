...
public class ProgressBar extends JPanel
{
	...
	private class ThreadProgreso extends Thread
	{
		...
		/**
		 * Constructor del Thread, se pasan los parametros necesarios para pintar<br>
		 * Al terminar la ejecución, ejecuta los threads que estan en cola
		 *
		 * @param pProgreso Progreso a pintar
		 * @param timeDelay Delay del pintado. Si es -1, se toma 50 ms como predefinido
		 * @see ProgressBar#setProgressBar(double, long)
		 */
